...
def standard_pipeline_group():
    return GoCdConfigurator(config('config-with-typical-pipeline')).ensure_replacement_of_pipeline_group('P.Group')
...
def more_options_pipeline():
    return GoCdConfigurator(config('config-with-more-options-pipeline')).ensure_replacement_of_pipeline_group('P.Group').find_pipeline('more-options')


def empty_pipeline():
    return GoCdConfigurator(empty_config()).ensure_replacement_of_pipeline_group("pg").ensure_pipeline("pl").set_git_url("gurl")
...
class TestJobs(unittest.TestCase):
    ...
    def test_job_that_has_no_artifacts_has_no_artifacts_element_to_reduce_thrash(self):
        ...
        job = go_cd_configurator.ensure_replacement_of_pipeline_group("g").ensure_pipeline("p").ensure_stage("s").ensure_job("j")
    ...
    def test_can_have_encrypted_environment_variables(self):
        pipeline = GoCdConfigurator(config('config-with-encrypted-variable')).ensure_replacement_of_pipeline_group("defaultGroup").find_pipeline("example")
    ...
    def test_environment_variables_get_added_in_sorted_order_to_reduce_config_thrash(self):
        ...
        job = go_cd_configurator\
            .ensure_replacement_of_pipeline_group('P.Group')\
...
class TestPipeline(unittest.TestCase):
    ...
    def test_git_is_polled_by_default(self):
        pipeline = GoCdConfigurator(empty_config()).ensure_replacement_of_pipeline_group("g").ensure_pipeline("p")
    ...
    def test_git_material_can_ignore_sources(self):
        pipeline = GoCdConfigurator(config('config-with-source-exclusions')).ensure_replacement_of_pipeline_group("P.Group").find_pipeline("with-exclusions")
    ...
    def test_materials_are_sorted(self):
        go_cd_configurator = GoCdConfigurator(empty_config())
        pipeline = go_cd_configurator.ensure_replacement_of_pipeline_group("g").ensure_pipeline("p")
    ...
    def test_pipelines_can_be_based_on_template(self):
        pipeline = GoCdConfigurator(config('pipeline-based-on-template')).ensure_replacement_of_pipeline_group('defaultGroup').find_pipeline('siberian')
    ...
    def test_pipelines_can_be_created_based_on_template(self):
        ...
        configurator.ensure_replacement_of_template('temple').ensure_stage('s').ensure_job('j')
        pipeline = configurator.ensure_replacement_of_pipeline_group("g").ensure_pipeline('p').set_template_name('temple')
    ...
    def test_pipelines_have_unencrypted_secure_environment_variables(self):
        pipeline = GoCdConfigurator(config('config-with-unencrypted-secure-variable')).ensure_replacement_of_pipeline_group("defaultGroup").find_pipeline("example")
    ...
    def test_pipelines_have_unencrypted_secure_environment_variable_unicode(self):
        pipeline = GoCdConfigurator(config('config-with-unencrypted-secure-variable-unicode')).ensure_replacement_of_pipeline_group("defaultGroup").find_pipeline("example")
    ...
    def test_can_have_timer_with_onlyOnChanges_option(self):
        pipeline = GoCdConfigurator(config('config-with-more-options-pipeline')).ensure_replacement_of_pipeline_group('P.Group').find_pipeline('pipeline2')
        self.assertEquals(True, pipeline.has_timer)
    ...
    def test_need_not_have_timer(self):
        pipeline = GoCdConfigurator(empty_config()).ensure_replacement_of_pipeline_group('Group').ensure_pipeline('Pipeline')
    ...
    def test_can_set_automatic_pipeline_locking(self):
        configurator = GoCdConfigurator(empty_config())
        pipeline = configurator.ensure_replacement_of_pipeline_group("new_group").ensure_pipeline("some_name")
...
class TestPipelineGroup(unittest.TestCase):
    def _pipeline_group_from_config(self):
        return GoCdConfigurator(config('config-with-two-pipelines')).ensure_replacement_of_pipeline_group('P.Group')
    ...
    def test_can_add_pipeline(self):
        configurator = GoCdConfigurator(empty_config())
        pipeline_group = configurator.ensure_replacement_of_pipeline_group("new_group")
        new_pipeline = pipeline_group.ensure_pipeline("some_name")
...
class TestGoCdConfigurator(unittest.TestCase):
    def test_can_tell_if_there_is_no_change_to_save(self):
        ...
        p = configurator.ensure_replacement_of_pipeline_group('Second.Group').ensure_replacement_of_pipeline('smoke-tests')
    ...
    def test_can_add_pipeline_group(self):
        ...
        new_pipeline_group = configurator.ensure_replacement_of_pipeline_group("a_new_group")
    ...
    def test_can_ensure_pipeline_group_exists(self):
        ...
        pre_existing_pipeline_group = configurator.ensure_replacement_of_pipeline_group('Second.Group')
        self.assertEquals(2, len(configurator.pipeline_groups))
    ...
    def test_can_add_template(self):
        configurator = GoCdConfigurator(empty_config())
        template = configurator.ensure_replacement_of_template('foo')
    ...
    def test_top_level_elements_get_reordered_to_please_go(self):
        ...
        configurator.ensure_replacement_of_pipeline_group("some_group").ensure_pipeline("some_pipeline")
        xml = configurator.config
        root = ET.fromstring(xml)
    ...
    def test_top_level_elements_with_environment_get_reordered_to_please_go(self):
        ...
        configurator.ensure_replacement_of_pipeline_group("P.Group").ensure_pipeline("some_pipeline")
    ...
    def test_elements_can_be_created_in_order_to_please_go(self):
        configurator = GoCdConfigurator(empty_config())
        pipeline = configurator.ensure_replacement_of_pipeline_group("some_group").ensure_pipeline("some_pipeline")
    ...
    def test_elements_are_reordered_in_order_to_please_go(self):
        ...
        self.__configure_stage(configurator.ensure_replacement_of_template('templ'))
...
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line")
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_standard_label(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_default_label_template()
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_non_standard_label(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_label_template("non standard")
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_automatic_pipeline_locking(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_automatic_pipeline_locking()
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_pipeline_material(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").ensure_material(PipelineMaterial("p", "s", "m"))
#         self.check_round_trip_pipeline(configurator, before)
...
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_git_url("some git url")
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_git_extras(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_git_material(
...
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_git_material(GitMaterial("some git url", branch="some branch"))
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_git_material_only(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_git_material(GitMaterial("some git url", material_name="m name"))
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_git_polling_only(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_git_material(GitMaterial("some git url", polling=False))
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_git_ignore_patterns_only_ISSUE_4(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_git_material(GitMaterial("git url", ignore_patterns={"ex", "cluded"}))
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_git_destination_directory_only(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_git_material(GitMaterial("git url", destination_directory='foo/bar'))
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_pipeline_parameters(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").ensure_parameters({"p": "v"})
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_pipeline_environment_variables(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").ensure_environment_variables({"p": "v"})
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_pipeline_encrypted_environment_variables(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").ensure_encrypted_environment_variables({"p": "v"})
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_pipeline_unencrypted_secure_environment_variables(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").ensure_unencrypted_secure_environment_variables({"p": "v"})
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_timer(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_timer("some timer")
#         self.check_round_trip_pipeline(configurator, before)

#     def test_can_round_trip_timer_only_on_changes(self):
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_timer("some timer", only_on_changes=True)
#         self.check_round_trip_pipeline(configurator, before)
...
#         configurator = GoCdConfigurator(empty_config())
#         before = configurator.ensure_replacement_of_pipeline_group("group").ensure_pipeline("line").set_template_name("temple")
#         configurator.ensure_replacement_of_template("temple").ensure_stage("stage").ensure_job("job")
